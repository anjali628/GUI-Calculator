...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button1,button2,button3,button4,button5,button6,button7,button8,button9,button0,button00,buttonClear,backSpace,buttonAdd,buttonSubtact,buttonMutiply,buttonDot,buttonEqual,buttonPercent,buttonDivide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubtact=findViewById(R.id.buttonSubtact);
        buttonMutiply=findViewById(R.id.buttonMultiply);
        ...
        button00.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String text;
                text=textView2.getText().toString()+button00.getText().toString();
                textView2.setText(text);
        ...
        buttonSubtact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String primary;
                first=Double.parseDouble((String) textView2.getText());
        ...
        buttonMutiply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String primary;
                first=Double.parseDouble((String) textView2.getText());
